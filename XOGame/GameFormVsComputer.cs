...
namespace XOGame
{
    public partial class GameFormVsComputer : Form
    {
        public GameFormVsComputer()
        {
            InitializeComponent();
            board = new char[9];
            ...
            if (board[buttonIndex] == ' ')
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        Turn_lab.Text = $"{currentPlayer} Turn";
                        if (currentPlayer == 'O')
                        {
                            ComputerMove();
                        }
        ...
        private void GameFormVsComputer_Load(object sender, EventArgs e)
        {
            var players = PlayersInfoServices.SelectPlayersInfo();
            Player1Name.Text = players.Player1Name;
            Player2Name.Text = players.Player2Name;
